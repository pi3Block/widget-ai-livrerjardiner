"""
Templates de prompts pour le module LLM.

Ce module contient les définitions des templates de prompts utilisés
pour les différentes interactions avec le modèle de langage.
"""
